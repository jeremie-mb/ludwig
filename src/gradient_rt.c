...
int gradient_rt_init(pe_t * pe, rt_t * rt, const char * fieldname,
  ...
  if (n == 0) {
    ...
    else if (strcmp(keyvalue, "3d_27pt_solid_double_symmetric") == 0) {
      pe_info(pe, "3d_27pt_solid_double_symmetric\n");
      f2 = grad_3d_27pt_solid_double_symmetric_d2;
      f4 = NULL;
      field_grad_dab_set(grad, grad_3d_27pt_solid_double_symmetric_dab);
      assert(map);
      grad_3d_27pt_solid_double_symmetric_map_set(map);
    }

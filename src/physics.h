...
__host__ int physics_grad_mu_set(physics_t * phys, double gm[3]);
__host__ int physics_ext_grad_mu_phi_set(physics_t * phys, double ext_grad_mu_phi_set[3]);
__host__ int physics_ext_grad_mu_psi_set(physics_t * phys, double ext_grad_mu_psi_set[3]);
